...
function TonySSCScreen({navigation}) { 
          ...
          <View style={styles.button}>
            ...
            <Modal visible={QROpen} animationType='slide'style={{ justifyContent: 'flex-end', margin: 0 }}>
                <View style={{flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <QRCode
                        value='https://user-images.githubusercontent.com/89670135/163492888-629ca200-14ff-4d1b-b37f-38382da427c7.png'
                        size={250}
                        color = "#26558b"
                    />
                    <TouchableOpacity
