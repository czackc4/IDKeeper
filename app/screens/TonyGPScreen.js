...
function TonyGPScreen({navigation}) { 
          ...
          <View style={styles.button}>
            ...
            <Modal visible={QROpen} animationType='slide'style={{ justifyContent: 'flex-end', margin: 0 }}>
                <View style={{flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <QRCode
                        value='https://user-images.githubusercontent.com/89670135/163032138-aa77e662-b9f6-4ced-991f-d6f306a1ff52.png'
                        size={250}
                        color = "#26558b"
                    />
                    <TouchableOpacity
            ...
            <Modal visible={DetailOpen} animationType='fade'style={{ justifyContent: 'flex-end', margin: 0 }}>
                <View style={{flex: 1, justifyContent: 'space-evenly', alignItems: 'center' , flexDirection: 'row', marginTop: 30}}>
                    <View style={styles.detailRowOne}>
                        <Image style ={styles.caliLogo} source={
                            require('../assets/Cali_Logo.png')} />
                    </View>
                    <View style={[styles.detailRowTwo , {marginTop: 50}]}>
                        <Text style={styles.text}>Name:            Anthony Stark</Text>
                        <Text style={styles.text}>DOB:               05/29/1970</Text>
                        <Text style={styles.text}>Address:        10880 Malibu Point, Malibu</Text>
                        <Text style={styles.text}>Occupation:   Avenger</Text>
                        <Text style={styles.text}>Height:            6'1"</Text>
                        <Text style={styles.text}>Weight:           225 lb</Text>
                        <Text style={styles.text}>Eye Color:       Brown</Text>
                        <Text style={styles.text}>Hair Color:      Black</Text>
                    </View>
                </View>
